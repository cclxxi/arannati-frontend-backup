...
import { Send, User, Circle, Search, MessageSquare, MoreVertical, Radio } from 'lucide-react';
import { Badge, Avatar, Dropdown, Input, Button, Modal, Select, Form, Spin, Empty } from 'antd';
...
export default function AdminChatsPage() {
    ...
    const { data: chatMessages = []} = useQuery({
        ...
        queryFn: async () => {
            ...
            const response = await apiClient.get(`/api/messages/chat/${selectedChat.id}`);
                    ...
                    <div className="p-4 bg-yellow-50 border-b border-yellow-200">
                        ...
                        {supportRequests.map(request => (
                            ...
                            >
                                ...
                                <div className="text-sm text-gray-600 truncate">{request.content}</div>
                                    ...
                                    <div className="flex items-center space-x-3 flex-1">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <Badge
                                                    count={chat.userRole === 'COSMETOLOGIST' ? 'Косметолог' : 'Клиент'}
                                                    style={{
                                                        backgroundColor: chat.userRole === 'COSMETOLOGIST' ? '#8b5cf6' : '#3b82f6',
                                                        fontSize: '10px',
                                                        height: '16px',
                                                        lineHeight: '16px',
                                                        padding: '0 6px'
                        ...
                        <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                            ...
                            {typingUsers.has(selectedChat.userId) && (
                                <div className="flex items-center space-x-2 text-gray-500 mb-4">
                                    ...
                                    <span className="text-sm">{selectedChat.userName} печатает...</span>
                                </div>
                            )}
                ...
                <Form form={form} onFinish={handleBroadcast} layout="vertical">
                    ...
                    >
                        <Select>
                            ...
                            <Select.Option value="cosmetologists">Только косметологи</Select.Option>
                        </Select>
                    </Form.Item>
