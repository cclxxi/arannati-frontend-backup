...
export default function MessagesPage() {
  ...
  useEffect(() => {
    ...
    const unsubMessage = wsClient.onMessage((message) => {
      console.log("Messages page received message:", message);
          ...
          <div className="flex items-end space-x-4">
            <div className="flex-1">
              <textarea
                ...
                className="w-full px-4 py-3 bg-gray-50 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all disabled:opacity-50 disabled:cursor-not-allowed resize-none"
            ...
            <button
              ...
              className="p-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-opacity hover:shadow-lg"
            >
              {isSending ? (
