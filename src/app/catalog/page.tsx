...
export default function CatalogPage() {
    ...
    const handleFilterChange = (key: keyof Filters, value: string | string[] | number | boolean | undefined) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <Drawer
                ...
                width={300}
            >
                {/* Те же фильтры, что и в боковой панели */}
                <div className="space-y-6">
                    {/* Копия фильтров из десктоп версии */}
                </div>
            </Drawer>
        </div>
    );
