...
export default function BrandsSection() {
    ...
    const { data: brands = BRANDS_DATA, isLoading, refetch } = useQuery({
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6">
                    {isLoading
                        ...
                        Array.from({ length: 8 }).map((_, index) => (
                            <div key={index} className="bg-white dark:bg-forest/50 rounded-2xl p-6">
                        ...
                        brands.map((brand, index) => (
                            <motion.div
                                ...
                                className="group relative bg-white dark:bg-forest/50 rounded-2xl p-4 sm:p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer"
                            >
                                ...
                                <div className="relative">
                                    ...
                                    <motion.div
                                        ...
                                        animate={{
                                            ...
                                            height: hoveredBrand === brand.id ? "auto" : 0
                                        }}
                ...
                {selectedBrand && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-white dark:bg-forest rounded-3xl p-6 sm:p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto"
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    ...
                                    <p className="text-brown dark:text-beige">{selectedBrand.country}</p>
                                </div>
                                <button
                                    onClick={() => setSelectedBrand(null)}
                            ...
                            <div className="space-y-4">
                                <p className="text-forest dark:text-beige-light leading-relaxed">
                                    {selectedBrand.fullDescription || selectedBrand.shortDescription}
                                </p>
                                ...
                                {selectedBrand.lastUpdated && (
                                    <p className="text-xs text-gray-500 dark:text-gray-400">
                                        Информация обновлена: {new Date(selectedBrand.lastUpdated).toLocaleDateString("ru")}
                                    </p>
                                )}
                            </div>
